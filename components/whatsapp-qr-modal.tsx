    ...
    variant === "card" ? (
      ...
      >
        <WhatsAppBusinessIcon
          className={iconClassName ?? "h-7 w-7 shrink-0 text-[#25D366]"}
        />
        <span className="min-w-0">
          <span className="block text-sm font-semibold leading-snug text-white sm:text-base">
            Napište nám na WhatsApp
          </span>
          <span className="mt-0.5 block text-xs leading-snug text-white/65 sm:text-sm">
