...
export function CookieBanner() {
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 right-0 z-[60] border-t border-black/10 bg-[#f9f9f9] p-4 shadow-[0_-4px_24px_rgba(0,0,0,0.08)] sm:p-6"
    >
      <div className="mx-auto flex max-w-[80rem] flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
