      ...
      <div className="mx-auto flex max-w-[72rem] items-center justify-between gap-4 px-4 py-3 sm:px-10 lg:px-16 xl:px-20 2xl:px-24">
        <Link href="/" className="flex min-h-[44px] min-w-0 shrink items-center gap-3">
          <Image
            ...
            alt="Dočasný výkup s.r.o."
            width={44}
            height={44}
            className="h-11 w-11 shrink-0 rounded-full object-cover md:hidden"
            priority
          />
          <span className="hidden font-[family-name:var(--font-cardo)] text-lg font-semibold leading-tight tracking-tight text-[#111] sm:text-xl md:inline">
            Dočasný výkup s.r.o.
          </span>
        </Link>
