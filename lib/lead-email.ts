...
<div style="font-family: system-ui, sans-serif, Arial; font-size: 14px; color: #333333; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; background-color: #ffffff;">
  ...
  <div style="margin-top: 30px; padding-top: 15px; border-top: 1px dashed #cccccc;">
    ...
    <p style="margin: 5px 0;">📞 Telefon:<br>
      ...
      <a style="color: #1a5a9c; text-decoration: none;" href="tel:+420776680720">+420 776 680 720</a>
    </p>
    <p style="margin: 5px 0;">📧 E-mail: <a style="color: #1a5a9c; text-decoration: none;" href="mailto:info@docasnyvykup.cz">info@docasnyvykup.cz</a></p>
  </div>
  <div style="margin-top: 30px;">
    <p style="margin: 0;">Těšíme se na spolupráci!</p>
    <p style="margin: 5px 0 0 0;">S pozdravem,</p>
    <p style="margin: 0; font-weight: bold; color: #1a5a9c;">Váš tým Dočasný výkup s.r.o.</p>
  </div>
</div>`.trim()
}
...
export function buildLeadEmails(params: LeadPayload & { ip: string }): BuiltLeadEmails {
  ...
  const clientSubject = "Potvrzení přijetí poptávky – Dočasný výkup"
  const clientText = [
    ...
    "",
    "Telefon: +420 776 075 150 / +420 776 680 720",
    "E-mail: info@docasnyvykup.cz",
    "",
    "S pozdravem,",
    "Váš tým Dočasný výkup s.r.o.",
  ].join("\n")
