        ...
        <section className="py-12 lg:py-16">
          <Container>
            <article className="mx-auto max-w-3xl">
              <h2 className="mt-0 text-xl font-bold text-[var(--color-foreground)] md:text-2xl">1. Co jsou cookies</h2>
              ...
              <h2 className="mt-12 text-xl font-bold text-[var(--color-foreground)] md:text-2xl">2. Jaké cookies používáme</h2>
              ...
              <h2 className="mt-12 text-xl font-bold text-[var(--color-foreground)] md:text-2xl">3. Správce a právní základ</h2>
              <p className="mt-4 text-base leading-relaxed text-[var(--color-muted)]">
              ...
              <h2 className="mt-12 text-xl font-bold text-[var(--color-foreground)] md:text-2xl">4. Jak cookies odmítnout</h2>
              <p className="mt-4 text-base leading-relaxed text-[var(--color-muted)]">
              ...
              <h2 className="mt-12 text-xl font-bold text-[var(--color-foreground)] md:text-2xl">5. Kontakt</h2>
              <p className="mt-4 text-base leading-relaxed text-[var(--color-muted)]">
                Dotazy k cookies:{" "}
